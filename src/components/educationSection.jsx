...
const EducationArray = [
  ...
  },
  {
    ...
    description: [
      ...
      "🏃‍♂️ Once crowned Under-16 Athletics Champion (flex), and ran like my PT sir was chasing me.",
      ...
      "🎬 Head of the Media Lab, where I directed short films, made music videos, and even grabbed a few awards (Spielberg vibes).",
      "🏅 Twice the Sports Captain of my house, which basically means I shouted at juniors to run faster, but hey, leadership!",
    ],
