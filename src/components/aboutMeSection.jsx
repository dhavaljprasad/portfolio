...
const PlacesArray = [
  {
    ...
    description: "",
    role: "AI Product Engineer (Software Developer)",
  },
  {
  ...
  },
  {
    ...
    description: "",
    role: "Full Stack Software Developer (Intern + Full Time)",
  },
];
...
function AboutMeSection() {
  return (
    <div className="w-full h-auto flex flex-col gap-4">
      <h1 className="text-2xl font-bold text-white">Cool places I worked at</h1>
